  ...
  ${b.mainStart()}
    ...
    ${C.setByOffset("global_idx",w.getByIndices("aIndices"))}
       ...
       `,b=w=>`
        ...
        }`;return{name:e,shaderCache:{hint:`${t};${g}`,inputDependencies:["type"]},getShaderSource:b,getRunData:()=>({outputs:[{dims:r,dataType:n}],dispatchGroup:{x:p},programUniforms:[{type:12,data:d}]})}},Ve=(e,t,i,a)=>{let n=e.inputs.length===1?i:wa(e.inputs,i),r=n.axes;r.length===0&&!n.noopWithEmptyAxes&&(r=e.inputs[0].dims.map((_,b)=>b));let o=O.normalizeAxes(r,e.inputs[0].dims.length),u=o,p=e.inputs[0],d=so(u,e.inputs[0].dims.length);d.length>0&&(p=e.compute(qe(e.inputs[0],d),{inputs:[0],outputs:[-1]})[0],u=io(u.length,p.dims.length));let[f,m]=ro(p.dims,u),g=f;n.keepDims&&(g=ao(f,o)),e.compute(oo(t,n.cacheKey,[p],a,e.inputs[0].dataType,g,m),{inputs:[p]})},Pd=(e,t)=>{Ve(e,"ReduceMeanShared",t,"mean")},Ud=(e,t)=>{Ve(e,"ReduceL1Shared",t,"l1")},qd=(e,t)=>{Ve(e,"ReduceL2Shared",t,"l2")},Wd=(e,t)=>{Ve(e,"ReduceLogSumExpShared",t,"logSumExp")},Ld=(e,t)=>{Ve(e,"ReduceMaxShared",t,"max")},Vd=(e,t)=>{Ve(e,"ReduceMinShared",t,"min")},jd=(e,t)=>{Ve(e,"ReduceProdShared",t,"prod")},Gd=(e,t)=>{Ve(e,"ReduceSumShared",t,"sum")},Hd=(e,t)=>{Ve(e,"ReduceSumSquareShared",t,"sumSquare")},Fd=(e,t)=>{Ve(e,"ReduceLogSumShared",t,"logSum")}}),je,uo,Vi,wa,Ge,lo,po,co,fo,ho,mo,go,_o,yo,bo,He,Kd,Zd,Yd,Xd,Qd,Jd,ep,tp,ip,rp,ja=q(()=>{re(),ne(),xe(),oe(),zm(),je=e=>{if(!e||e.length===0||e.length>2)throw new Error("Reduce op requires 1 or 2 inputs.");if(e.length===2&&e[1].dims.length!==1)throw new Error("Invalid axes input dims.")},uo=e=>["","",`var value = ${e.getByIndices("input_indices")};`,""],Vi=(e,t,i,a,n,r,o=!1,u=!1)=>{let p=[],d=i[0].dims,f=d.length,m=O.normalizeAxes(n,f),g=!u&&m.length===0;d.forEach((w,C)=>{g||m.indexOf(C)>=0?o&&p.push(1):p.push(w)});let _=p.length,b=O.size(p);return{name:e,shaderCache:t,getShaderSource:w=>{let C=[],v=N("_A",i[0].dataType,f),$=K("output",r,_),T=a(v,$,m),k=T[2];for(let S=0,E=0;S<f;S++)g||m.indexOf(S)>=0?(o&&E++,k=`for(var j${S}: u32 = 0; j${S} < ${d[S]}; j${S}++) {
...
var best_index : i32 = 0;`,`if (${a.getByIndices("input_indices")} ${t.selectLastIndex>0?">=":">"} value) {
  ...
  }`;return{name:"BatchNormalization",shaderCache:{hint:`${t.epsilon}_${t.format}_${a}_${o}`,inputDependencies:d?["rank","type","type","type","type"]:void 0},getShaderSource:$,getRunData:()=>({outputs:[{dims:e[0].dims,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(p/64)},programUniforms:d?[{type:12,data:p},...Q(r)]:[{type:12,data:p}]})}},So=e=>fe(e),op=(e,t)=>{let{inputs:i,outputCount:a}=e,n=So({...t,outputCount:a});if(be.webgpu.validateInputContent&&To(i,n),t.trainingMode)throw new Error("BatchNormalization trainingMode is not supported yet.");e.compute(ko(i,n))}}),Io,Eo,up,Rm=q(()=>{ne(),oe(),Io=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![320,640,1280].includes(e[0].dims[2]))throw new Error("number of channels should be 320, 640 or 1280");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},Eo=e=>{let t=e[0].dims,i=e[0].dims[2],a=O.size(t)/4,n=e[0].dataType,r=N("input",n,t,4),o=N("bias",n,[i],4),u=N("residual",n,t,4),p=K("output",n,t,4);return{name:"BiasAdd",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(a/64)}}),getShaderSource:d=>`
  ...
  }`}},up=e=>{Io(e.inputs),e.compute(Eo(e.inputs))}}),zo,pe,lp,dp,pp,cp,fp,hp,mp,gp,_p,Ao,yp,bp,wp,$p,li,vp,Pi,xp,Cp,Tp,kp,Sp,Ip,Ep,zp,Ap,Op,Rp,Bp,Np,Dp,Mp,Pp,qr,Up,va,xa,qp,Wp,Lp,Oo,Ro,Vp,Ha=q(()=>{re(),ne(),xe(),oe(),zo=(e,t,i,a,n,r,o)=>{let u=Math.ceil(t/4),p="";typeof n=="string"?p=`${n}(a)`:p=n("a");let d=N("inputData",i,[u],4),f=K("outputData",a,[u],4),m=[{name:"vec_size",type:"u32"}];return o&&m.push(...o),`
  ...
  }`},pe=(e,t,i,a,n,r=e.dataType,o,u)=>{let p=[{type:12,data:Math.ceil(O.size(e.dims)/4)}];return o&&p.push(...o),{name:t,shaderCache:{hint:n,inputDependencies:["type"]},getShaderSource:d=>zo(d,O.size(e.dims),e.dataType,r,i,a,u),getRunData:d=>({outputs:[{dims:e.dims,dataType:r}],dispatchGroup:{x:Math.ceil(O.size(d[0].dims)/64/4)},programUniforms:p})}},lp=e=>{e.compute(pe(e.inputs[0],"Abs","abs"))},dp=e=>{e.compute(pe(e.inputs[0],"Acos","acos"))},pp=e=>{e.compute(pe(e.inputs[0],"Acosh","acosh"))},cp=e=>{e.compute(pe(e.inputs[0],"Asin","asin"))},fp=e=>{e.compute(pe(e.inputs[0],"Asinh","asinh"))},hp=e=>{e.compute(pe(e.inputs[0],"Atan","atan"))},mp=e=>{e.compute(pe(e.inputs[0],"Atanh","atanh"))},gp=e=>fe(e),_p=(e,t)=>{let i;switch(t.to){case 10:i="vec4<f16>";break;case 1:i="vec4<f32>";break;case 12:i="vec4<u32>";break;case 6:i="vec4<i32>";break;case 9:i="vec4<bool>";break;default:throw new RangeError(`not supported type (specified in attribute 'to' from 'Cast' operator): ${t.to}`)}e.compute(pe(e.inputs[0],"Cast",i,void 0,t.cacheKey,t.to))},Ao=e=>{let t,i,a=e.length>=2&&e[1].data!==0,n=e.length>=3&&e[2].data!==0;switch(e[0].dataType){case 1:t=a?e[1].getFloat32Array()[0]:-34028234663852886e22,i=n?e[2].getFloat32Array()[0]:34028234663852886e22;break;case 10:t=a?e[1].getUint16Array()[0]:64511,i=n?e[2].getUint16Array()[0]:31743;break;default:throw new Error("Unsupport data type")}return fe({min:t,max:i})},yp=(e,t)=>{let i=t||Ao(e.inputs),a=ze(e.inputs[0].dataType);e.compute(pe(e.inputs[0],"Clip",n=>`clamp(${n}, vec4<${a}>(uniforms.min), vec4<${a}>(uniforms.max))`,void 0,i.cacheKey,void 0,[{type:e.inputs[0].dataType,data:i.min},{type:e.inputs[0].dataType,data:i.max}],[{name:"min",type:a},{name:"max",type:a}]),{inputs:[0]})},bp=e=>{e.compute(pe(e.inputs[0],"Ceil","ceil"))},wp=e=>{e.compute(pe(e.inputs[0],"Cos","cos"))},$p=e=>{e.compute(pe(e.inputs[0],"Cosh","cosh"))},li=e=>fe(e),vp=(e,t)=>{let i=ze(e.inputs[0].dataType);e.compute(pe(e.inputs[0],"Elu",a=>`elu_vf32(${a})`,`
...
}`,xp=e=>{let t=ze(e.inputs[0].dataType);e.compute(pe(e.inputs[0],"Erf",i=>`erf_vf32(${i})`,Pi(t)))},Cp=e=>{e.compute(pe(e.inputs[0],"Exp","exp"))},Tp=e=>{e.compute(pe(e.inputs[0],"Floor","floor"))},kp=e=>{let t=ze(e.inputs[0].dataType);e.compute(pe(e.inputs[0],"Gelu",i=>`0.5 * ${i} * (1.0 + erf_vf32(${i} * 0.7071067811865475))`,Pi(t)))},Sp=(e,t)=>{let i=ze(e.inputs[0].dataType);e.compute(pe(e.inputs[0],"LeakyRelu",a=>`select(leaky_relu_alpha_ * ${a}, ${a}, ${a} >= vec4<${i}>(0.0))`,`const leaky_relu_alpha_ = ${i}(${t.alpha});`,t.cacheKey))},Ip=e=>{e.compute(pe(e.inputs[0],"Not",t=>`!${t}`))},Ep=e=>{e.compute(pe(e.inputs[0],"Neg",t=>`-${t}`))},zp=e=>{e.compute(pe(e.inputs[0],"Reciprocal",t=>`1.0/${t}`))},Ap=e=>{let t=ze(e.inputs[0].dataType);e.compute(pe(e.inputs[0],"Relu",i=>`select(vec4<${t}>(0.0), ${i}, ${i} > vec4<${t}>(0.0))`))},Op=e=>{e.compute(pe(e.inputs[0],"Sigmoid",t=>`(1.0 / (1.0 + exp(-${t})))`))},Rp=e=>fe(e),Bp=(e,t)=>{let i=ze(e.inputs[0].dataType);e.compute(pe(e.inputs[0],"HardSigmoid",a=>`max(vec4<${i}>(0.0), min(vec4<${i}>(1.0), ${t.alpha} * ${a} + vec4<${i}>(${t.beta})))`,void 0,t.cacheKey))},Np=e=>{e.compute(pe(e.inputs[0],"Sin","sin"))},Dp=e=>{e.compute(pe(e.inputs[0],"Sinh","sinh"))},Mp=e=>{e.compute(pe(e.inputs[0],"Sqrt","sqrt"))},Pp=e=>{e.compute(pe(e.inputs[0],"Tan","tan"))},qr=e=>`sign(${e}) * (1 - exp(-2 * abs(${e}))) / (1 + exp(-2 * abs(${e})))`,Up=e=>{e.compute(pe(e.inputs[0],"Tanh",qr))},va=(e="f32")=>`
...
`,xa=e=>`(fast_gelu_a + fast_gelu_a * tanh_v(${e} * (fast_gelu_c * ${e} * ${e} + fast_gelu_b))) * ${e}`,qp=e=>{let t=ze(e.inputs[0].dataType);e.compute(pe(e.inputs[0],"FastGelu",xa,va(t),void 0,e.inputs[0].dataType))},Wp=(e,t)=>{let i=ze(e.inputs[0].dataType);return e.compute(pe(e.inputs[0],"ThresholdedRelu",a=>`select(vec4<${i}>(0.0), ${a}, ${a} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_ = vec4<${i}>(${t.alpha});`,t.cacheKey)),0},Lp=e=>{e.compute(pe(e.inputs[0],"Log","log"))},Oo=(e,t)=>`
...
`,Ro=e=>`quick_gelu_impl(${e})`,Vp=(e,t)=>{let i=ze(e.inputs[0].dataType);e.compute(pe(e.inputs[0],"QuickGelu",Ro,Oo(i,t.alpha),t.cacheKey,e.inputs[0].dataType))}}),Bo,No,jp,Bm=q(()=>{ne(),oe(),Ha(),Bo=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},No=e=>{let t=e[0].dims.slice();t[2]=t[2]/2;let i=N("input",e[0].dataType,e[0].dims,4),a=N("bias",e[0].dataType,[e[0].dims[2]],4),n=K("output",e[0].dataType,t,4),r=O.size(t)/4,o=Se(e[0].dataType);return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(r/64)}}),getShaderSource:u=>`
  ...
  ${u.mainStart()}
    ...
    fn pow_vector_custom(a : vec4<${t}>, b : vec4<${t}>) -> vec4<${t}> {
      ...
      `)},Yp=e=>{Fe(e,"Sub",(t,i)=>`${t}-${i}`)},Xp=e=>{Fe(e,"Greater",{scalar:(t,i)=>`u32(${t}>${i})`,vector:(t,i)=>`vec4<u32>(${t}>${i})`},void 0,void 0,9)},Qp=e=>{Fe(e,"Less",{scalar:(t,i)=>`u32(${t}<${i})`,vector:(t,i)=>`vec4<u32>(${t}<${i})`},void 0,void 0,9)},Jp=e=>{Fe(e,"GreaterOrEqual",{scalar:(t,i)=>`u32(${t}>=${i})`,vector:(t,i)=>`vec4<u32>(${t}>=${i})`},void 0,void 0,9)},ec=e=>{Fe(e,"LessOrEqual",{scalar:(t,i)=>`u32(${t}<=${i})`,vector:(t,i)=>`vec4<u32>(${t}<=${i})`},void 0,void 0,9)}}),Po,Uo,qo,Wo,tc,ic,Dm=q(()=>{re(),ne(),xe(),oe(),Po=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");let i=0,a=e[i],n=a.dataType,r=a.dims.length;e.forEach((o,u)=>{if(u!==i){if(o.dataType!==n)throw new Error("input tensors should be one type");if(o.dims.length!==r)throw new Error("input tensors should have the same shape");o.dims.forEach((p,d)=>{if(d!==t&&p!==a.dims[d])throw new Error("non concat dimensions must match")})}})},Uo=(e,t)=>`
...
`)},Wo=(e,t,i,a)=>{let n=O.size(i),r=new Array(e.length),o=new Array(e.length),u=0,p=[],d=[],f=[{type:12,data:n}];for(let w=0;w<e.length;++w)u+=e[w].dims[t],r[w]=u,d.push(e[w].dims.length),o[w]=N(`input${w}`,a,d[w]),p.push("rank"),f.push({type:12,data:r[w]});for(let w=0;w<e.length;++w)f.push(...Q(e[w].dims));f.push(...Q(i));let m=K("output",a,i.length),g=m.indicesGet("indices",t),_=Array.from(Array(r.length).keys()).map(w=>`uniforms.sizeInConcatAxis${w}`).join(","),b=w=>`
  ...
  ${w.mainStart()}
    ...
    ${qo(o,m)}
  }`;return{name:"Concat",shaderCache:{hint:`${t}`,inputDependencies:p},getRunData:()=>({outputs:[{dims:i,dataType:a}],dispatchGroup:{x:Math.ceil(n/64)},programUniforms:f}),getShaderSource:b}},tc=(e,t)=>{let i=e.inputs,a=i[0].dims,n=O.normalizeAxis(t.axis,a.length);Po(i,n);let r=a.slice();r[n]=i.reduce((u,p)=>u+(p.dims.length>n?p.dims[n]:0),0);let o=i.filter(u=>O.size(u.dims)>0);e.compute(Wo(o,n,r,i[0].dataType),{inputs:o})},ic=e=>fe({axis:e.axis})}),Bt,Nt,Dt,Fa,Pt=q(()=>{re(),ne(),Bt=(e,t,i="f32")=>{switch(e.activation){case"Relu":return`value = max(value, ${t}(0.0));`;case"Sigmoid":return`value = (${t}(1.0) / (${t}(1.0) + exp(-value)));`;case"Clip":return`value = clamp(value, ${t}(${i}(uniforms.clip_min)), ${t}(${i}(uniforms.clip_max)));`;case"HardSigmoid":return`value = max(${t}(0.0), min(${t}(1.0), ${i}(uniforms.alpha) * value + ${i}(uniforms.beta)));`;case"LeakyRelu":return`value = select(${i}(uniforms.alpha) * value, value, value >= ${t}(0.0));`;case"Tanh":return`let e2x = exp(-2.0 * abs(value));
              value = sign(value) * (1.0 - e2x) / (1.0 + e2x);
        `;case"":return"";default:throw new Error(`Unsupported activation ${e.activation}`)}},Nt=(e,t)=>{e.activation==="Clip"?t.push({type:1,data:e.clipMax},{type:1,data:e.clipMin}):e.activation==="HardSigmoid"?t.push({type:1,data:e.alpha},{type:1,data:e.beta}):e.activation==="LeakyRelu"&&t.push({type:1,data:e.alpha})},Dt=(e,t)=>{e.activation==="Clip"?t.push({name:"clip_max",type:"f32"},{name:"clip_min",type:"f32"}):e.activation==="HardSigmoid"?t.push({name:"alpha",type:"f32"},{name:"beta",type:"f32"}):e.activation==="LeakyRelu"&&t.push({name:"alpha",type:"f32"})},Fa=e=>{let t=(e==null?void 0:e.activation)||"";if(t==="HardSigmoid"){let[i,a]=(e==null?void 0:e.activation_params)||[.2,.5];return{activation:t,alpha:i,beta:a}}else if(t==="Clip"){let[i,a]=(e==null?void 0:e.activation_params)||[Id,Ed];return{activation:t,clipMax:a,clipMin:i}}else if(t==="LeakyRelu"){let[i]=(e==null?void 0:e.activation_params)||[.01];return{activation:t,alpha:i}}return{activation:t}}}),Ee,rc,Ka=q(()=>{Ee=(e,t)=>{switch(e){case 1:return t;case 2:return`vec2<${t}>`;case 3:return`vec3<${t}>`;case 4:return`vec4<${t}>`;default:throw new Error(`${e}-component is not supported.`)}},rc=e=>`
...
`},Go=(e,t,i,a,n=!1)=>{let[r,o,u,p]=a,d=Se(a[0].type.tensor);return`
  ...
  }`};return{name:"GroupedConv",shaderCache:{hint:`${t.cacheKey}_${m}`,inputDependencies:b},getRunData:()=>({outputs:[{dims:a?a(i):i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(g/64)},programUniforms:_}),getShaderSource:w}},lc=(e,t,i,a)=>{let n=e.length>2,r=ve(i[3]),o=ve(i[2]),u=O.size(i)/r/o,p=[e[0].dims[0],e[0].dims[1],e[0].dims[2],e[0].dims[3]/r],d=[e[1].dims[0],e[1].dims[1],e[1].dims[2],e[1].dims[3]/r],f=[i[0],i[1],i[2],i[3]/r],m=[{type:12,data:u},{type:6,data:[t.strides[0],t.strides[1]]},{type:6,data:[t.pads[0],t.pads[1]]}];Nt(t,m),m.push(...Q(p,d,f));let g=(o-1)*t.strides[1]+d[1],_=b=>{let w=K("output",e[0].dataType,f.length,r),C=Se(w.type.tensor),v=Bt(t,w.type.value,C),$=N("x",e[0].dataType,p.length,r),T=N("w",e[1].dataType,d.length,r),k=[$,T];n&&k.push(N("b",e[2].dataType,e[2].dims,r));let S=n?"value += b[output_channel];":"",E=[{name:"output_size",type:"u32"},{name:"strides",type:"i32",length:2},{name:"pads",type:"i32",length:2}];return Dt(t,E),`
  ...
  ${b.mainStart()}
    ...
    ${V}}`};return{name:"ConvTranspose2D",shaderCache:{hint:`${t.cacheKey};${f}${w}${b}${m}${_}`,inputDependencies:$},getRunData:()=>({dispatchGroup:{x:v[0],y:v[1],z:v[2]},outputs:[{dims:i?i(n):n,dataType:e[0].dataType}],programUniforms:R}),getShaderSource:M}}}),eu,tu,iu,Gr,pc,ru,Hr,au,cc,Vm=q(()=>{Lm(),Pt(),bt(),eu=(e,t,i,a,n,r)=>(e-1)*t+i+(a-1)*n+1-r,tu=(e,t,i,a,n)=>{let r=Math.floor(e/2);t==="SAME_UPPER"?(i[a]=r,i[n]=e-r):t==="SAME_LOWER"&&(i[a]=e-r,i[n]=r)},iu=(e,t,i,a,n,r,o,u,p,d)=>{let f=e.length-2,m=d.length===0;p.length<f&&p.push(...Array(f-p.length).fill(0));let g=e[0],_=t[u?3:1]*n;for(let b=0,w=e.length-f-(u?1:0);b<f;++b,++w){let C=e[w],v=m?C*o[b]:d[b],$=eu(C,o[b],r[b],t[w],i[b],v);tu($,a,r,b,b+f),m&&d.push(o[b]*(C-1)+p[b]+(t[w]-1)*i[b]+1-r[b]-r[b+f])}d.splice(0,0,g),d.splice(u?3:1,0,_)},Gr=(e,t)=>{let i=e.kernelShape.slice();if(e.kernelShape.length===0||e.kernelShape.reduce((m,g)=>m*g,1)===0){i.length=0;for(let m=2;m<t[1].dims.length;++m)i.push(t[1].dims[m])}let a=e.format==="NHWC";i.splice(0,0,t[1].dims[0]),i.splice(a?3:1,0,t[1].dims[1]);let n=e.pads.slice(),r=e.outputShape.slice(),o=e.outputPadding.slice(),u=t[0].dims,p=e.dilations.slice();if(p.reduce((m,g)=>m+g,0)===0){let m=t[0].dims.length-2;p=new Array(m).fill(1)}let d=e.strides.slice();if(d.reduce((m,g)=>m+g,0)===0){let m=t[0].dims.length-2;d=new Array(m).fill(1)}iu(u,i,p,e.autoPad,e.group,n,d,a,o,r);let f=Object.assign({},e);return Object.assign(f,{kernelShape:i,pads:n,outputPadding:o,outputShape:r,dilations:p,strides:d}),f},pc=e=>{let t=Fa(e),i=e.format,a=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][typeof e.autoPad>"u"?0:e.autoPad],n=e.dilations,r=e.group,o=e.kernelShape,u=e.pads,p=e.strides,d=e.wIsConst(),f=e.outputPadding,m=e.outputShape;return{autoPad:a,format:i,dilations:n,group:r,kernelShape:o,outputPadding:f,outputShape:m,pads:u,strides:p,wIsConst:d,...t,cacheKey:`${e.format};${t.activation};`}},ru=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length!==4&&e[0].dims.length!==3)throw new Error("currently only support 2-dimensional conv");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let i=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],a=e[1].dims[0];if(i!==a)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");let n=e[1].dims[1]*t.group;if(e.length===3&&(e[2].dims.length!==1||e[2].dims[0]!==n))throw new Error("invalid bias");let r=e[0].dims.length-2;if(t.dilations.reduce((o,u)=>o+u,0)>0&&t.dilations.length!==r)throw new Error(`dilations should be ${r}D`);if(t.strides.reduce((o,u)=>o+u,0)>0&&t.strides.length!==r)throw new Error(`strides should be ${r}D`);if(t.pads.reduce((o,u)=>o+u,0)>0&&t.pads.length!==r*2)throw new Error(`pads should be ${r*2}D`);if(t.outputPadding.length!==r&&t.outputPadding.length!==0)throw new Error(`output_padding should be ${r}D`);if(t.kernelShape.reduce((o,u)=>o+u,0)>0&&t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape");if(t.outputShape.length!==0&&t.outputShape.length!==e[0].dims.length-2)throw new Error("invalid output shape")},Hr=(e,t,i,a)=>{let n=e.kernelCustomData.wT??e.compute(qe(t[1],[2,3,0,1]),{inputs:[1],outputs:[i.wIsConst?-2:-1]})[0];i.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=n);let r=[t[0],n];t.length===3&&r.push(t[2]),e.compute(dc(r,i,a),{inputs:r})},au=(e,t)=>{let i=t.format==="NHWC",a=[e.inputs[0].reshape(i?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&a.push(e.inputs[2]);let n=t.kernelShape;(n.length===0||n[0]===0)&&(n=[e.inputs[1].dims[2]]);let r=t.dilations;(r.length===0||r[0]===0)&&(r=[1]);let o=t.strides;(o.length===0||o[0]===0)&&(o=[1]);let u=t.pads;u.length===0&&(u=[0,0]),u=[0,u[0],0,u[1]],o=[1].concat(o),r=[1].concat(r),n=[1].concat(n);let p=t.outputPadding;p=[0].concat(p);let d=Gr({...t,pads:u,strides:o,dilations:r,kernelShape:n,outputPadding:p},a);Hr(e,a,d,f=>i?[f[0],f[2],f[3]]:[f[0],f[1],f[3]])},cc=(e,t)=>{if(ru(e.inputs,t),e.inputs[0].dims.length===3)au(e,t);else{let i=Gr(t,e.inputs);Hr(e,e.inputs,i)}}}),nu,fc,hc,jm=q(()=>{re(),ne(),xe(),oe(),nu=(e,t,i,a)=>{let n=O.size(t),r=t.length,o=N("input",e,r),u=K("output",e,r),p=i.dataType===6?i.getInt32Array()[0]:Number(i.getBigInt64Array()[0]),d=O.normalizeAxis(p,r),f=m=>{let g=` i32(${o.indicesGet("inputIndices","uniforms.axis")}) `,_=X("uniforms.input_shape","uniforms.axis",r),b=a.reverse?g+(a.exclusive?" + 1":""):"0",w=a.reverse?_:g+(a.exclusive?"":" + 1");return`
                ...
                }`};return{name:"CumSum",shaderCache:{hint:a.cacheKey,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:t,dataType:e}],dispatchGroup:{x:Math.ceil(n/64)},programUniforms:[{type:12,data:n},{type:12,data:d},...Q(t,t)]}),getShaderSource:f}},fc=(e,t)=>{let i=e.inputs[0].dims,a=e.inputs[0].dataType,n=e.inputs[1];e.compute(nu(a,i,n,t),{inputs:[0]})},hc=e=>{let t=e.exclusive===1,i=e.reverse===1;return fe({exclusive:t,reverse:i})}}),su,ou,uu,mc,gc,Gm=q(()=>{re(),ne(),xe(),oe(),su=e=>{if(!e||e.length!==1)throw new Error("DepthToSpace requires 1 input.");if(e[0].dims.length!==4)throw new Error("DepthToSpace requires 4D input.")},ou=(e,t,i,a)=>{let n=[];n.push(`fn perm(i: ${a.type.indices}) -> ${i.type.indices} {
...
`)};
    ...
    ${b}`},f=[{type:12,data:p},...Q(t,a)];return{name:"Expand",shaderCache:{hint:`${a.length};${o}${u}`,inputDependencies:["rank"]},getShaderSource:d,getRunData:()=>({outputs:[{dims:a,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(p/64)},programUniforms:f})}},bc=e=>{hu(e.inputs),e.compute(gu(e.inputs),{inputs:[0]})}}),_u,wc,Km=q(()=>{re(),ne(),oe(),Ha(),_u=e=>{let t=e[0].dataType,i=O.size(e[0].dims),a=O.size(e[1].dims),n=a%4===0,r=o=>{let u=N("x",t,[1],4),p=N("bias",t,[1],4),d=K("y",t,[1],4),f=[{name:"output_vec_size",type:"u32"},{name:"bias_size",type:"u32"}],m=_=>`
  ...
  ${g.mainStart()}
    ...
    }`};return{name:"GatherBlockQuantized",shaderCache:{hint:`${t.cacheKey};${e.filter((_,b)=>b!==1).map(_=>_.dims.join("_")).join(";")}`,inputDependencies:Array.from({length:e.length},(_,b)=>"rank")},getRunData:()=>({outputs:[{dims:u,dataType:d}],dispatchGroup:{x:Math.ceil(p/64)},programUniforms:m}),getShaderSource:g}},Tc=(e,t)=>{let i=e.inputs;$u(i,t),e.compute(vu(e.inputs,t))},kc=e=>fe({blockSize:e.blockSize,gatherAxis:e.gatherAxis,quantizeAxis:e.quantizeAxis})}),xu,Cu,Sc,Ic,Qm=q(()=>{re(),ne(),xe(),oe(),xu=e=>{if(!e||e.length!==2)throw new Error("GatherElements requires 2 inputs.");if(e[0].dims.length<1)throw new Error("GatherElements requires that the data input be rank >= 1.");if(e[0].dims.length!==e[1].dims.length)throw new Error(`GatherElements requires that the data input and
...
`,Ru=(e,t,i)=>(()=>{switch(i.mode){case"nearest":return`
  ...
  }`};return e.compute({name:"MultiHeadAttentionAddBias",shaderCache:{inputDependencies:["type","type"]},getRunData:()=>({outputs:[{dims:u,dataType:t.dataType,gpuDataType:0}],dispatchGroup:{x:Math.ceil(p/64)},programUniforms:d}),getShaderSource:f},{inputs:[t,i],outputs:[-1]})[0]},di=(e,t,i,a,n,r,o,u)=>{let p=r;if(o&&O.size(o.dims)>0){if(a===1)throw new Error("AddBiasReshape is not implemented. Please export your model with packed QKV or KV");return p=Du(e,r,o,t,a,i*n,u),p=p.reshape([t,a,i,n]),i===1||a===1?p:e.compute(qe(p,Yr.perm),{inputs:[p],outputs:[-1]})[0]}else return r.dims.length===3&&(p=r.reshape([t,a,i,n])),i===1||a===1?p:e.compute(qe(p,Yr.perm),{inputs:[p],outputs:[-1]})[0]},Bc=(e,t)=>{let i=Nu(e.inputs,t),a=e.inputs[0],n=Re(e.inputs,1),r=Re(e.inputs,2),o=Re(e.inputs,3),u=Re(e.inputs,4),p=Re(e.inputs,5),d=Re(e.inputs,6),f=Re(e.inputs,7);if(a.dims.length===5)throw new Error("Packed QKV is not implemented");if((n==null?void 0:n.dims.length)===5)throw new Error("Packed KV is not implemented");let m=n&&r&&n.dims.length===4&&r.dims.length===4,g=di(e,i.batchSize,i.numHeads,i.sequenceLength,i.headSize,a,o,0);if(m)return fi(e,g,n,r,u,void 0,d,f,p,i);if(!n||!r)throw new Error("key and value must be provided");let _=di(e,i.batchSize,i.numHeads,i.kvSequenceLength,i.headSize,n,o,i.hiddenSize),b=di(e,i.batchSize,i.numHeads,i.kvSequenceLength,i.vHeadSize,r,o,2*i.hiddenSize);fi(e,g,_,b,u,void 0,d,f,p,i)}}),Mu,Pu,Uu,qu,Ia,Dc,Mc,Pc=q(()=>{re(),ne(),xe(),oe(),Mu=e=>{if(!e||e.length<1)throw new Error("too few inputs")},Pu=(e,t)=>{let i=[],a=t.numOutputs;return e[1].dims[0]>0&&(e[1].getBigInt64Array().forEach(n=>i.push(Number(n))),a=i.length),fe({numOutputs:a,axis:t.axis,splitSizes:i})},Uu=e=>`
...
`)}
  ...
  `};return{name:"GeneratePositionIds",shaderCache:{hint:`${e};${t}`,inputDependencies:r},getRunData:()=>({outputs:[{dims:o,dataType:n}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:p}),getShaderSource:d}},Wc=(e,t)=>{var k;let i=Lu(e.inputs,t);if(e.inputs[0].dims.length===5)throw new Error("Packed QKV is not implemented");if(((k=e.inputs[1])==null?void 0:k.dims.length)===5)throw new Error("Packed KV is not implemented");let a=e.inputs[0],n=e.inputs[1]&&e.inputs[1].dims.length>0?e.inputs[1]:void 0,r=e.inputs[2]&&e.inputs[2].dims.length>0?e.inputs[2]:void 0,o=e.inputs[3]&&e.inputs[3].dims.length!==0?e.inputs[3]:void 0,u=e.inputs[4]&&e.inputs[4].dims.length!==0?e.inputs[4]:void 0,p=e.inputs.length>4?e.inputs[5]:void 0,d=e.inputs.length>5?e.inputs[6]:void 0,f=i.kvNumHeads?i.kvNumHeads:i.numHeads,m=fe({axis:2,numOutputs:3,splitSizes:[i.numHeads*i.headSize,f*i.headSize,f*i.headSize]}),[g,_,b]=!n&&!r?e.compute(Ia([a],m),{inputs:[a],outputs:[-1,-1,-1]}):[a,n,r],w,C;if(t.doRotary){let S=e.compute(ju(i.batchSize,i.sequenceLength,p,d),{inputs:[p,d],outputs:[-1]})[0],E=e.inputs[7],z=e.inputs[8],R=fe({interleaved:t.rotaryInterleaved!==0,numHeads:i.numHeads,rotaryEmbeddingDim:0,scale:t.scale}),M=[g,S,E,z],L=[-1];w=e.compute(Gi(M,R),{inputs:M,outputs:L})[0],M.splice(0,1,_);let J=fe({interleaved:t.rotaryInterleaved!==0,numHeads:i.kvNumHeads,rotaryEmbeddingDim:0,scale:t.scale});C=e.compute(Gi(M,J),{inputs:M,outputs:L})[0]}let v=di(e,i.batchSize,i.numHeads,i.sequenceLength,i.headSize,t.doRotary?w:g,void 0,0),$=Xr(e,t.doRotary?C:_,i),T=Xr(e,b,i);fi(e,v,$,T,void 0,void 0,o,u,void 0,i,p,d)}}),Qr,Gu,Hu,Lc,ig=q(()=>{re(),ne(),bt(),oe(),Qr=(e,t,i,a,n,r,o,u)=>{let p=ve(r),d=p===1?"f32":`vec${p}f`,f=p===1?"vec2f":`mat2x${p}f`,m=n*o,g=64;m===1&&(g=256);let _=[n,o,r/p],b=[n,o,2],w=["rank","type","type"],C=[];C.push(...Q(_,b));let v=$=>{let T=N("x",t.dataType,3,p),k=N("scale",i.dataType,i.dims),S=N("bias",a.dataType,a.dims),E=K("output",1,3,2),z=[T,k,S,E];return`
  ...
  ${S.mainStart()}
    ...
    `,u="",p=N("x",t.dataType,t.dims.length),d=["rank"],[f,m,g,_,b]=ea(r,n);return f.push(...Q(t.dims,r)),{name:e,shaderCache:{hint:`${a.cacheKey};${g};${_};${b}`,inputDependencies:d},getRunData:()=>({outputs:[{dims:r,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(O.size(r)/64)},programUniforms:f}),getShaderSource:w=>ta(w,p,t.dims.length,r.length,n,o,u,t.dataType===10?-65504:-1e5,m,g,_,b)}},Qc=(e,t)=>{ri(e.inputs),e.compute(sa("MaxPool",e.inputs[0],!1,t))},Jc=e=>{let t=e.storage_order,i=e.dilations,a=ra(e);if(t!==0)throw new Error("column major storage order is not yet supported for MaxPool");if(a.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for MaxPool");let n={storageOrder:t,dilations:i,...a,cacheKey:""};return{...n,cacheKey:ul(n)}},ef=e=>{let t=e.format;return{format:t,...na,cacheKey:t}},tf=(e,t)=>{ri(e.inputs),e.compute(sa("GlobalMaxPool",e.inputs[0],!0,t))}}),ll,dl,rf,af,ug=q(()=>{re(),ne(),xe(),oe(),ll=(e,t)=>{if(e.length<2||e.length>3)throw new Error("DequantizeLinear requires 2 or 3 inputs.");if(e.length===3&&e[1].dims===e[2].dims)throw new Error("x-scale and x-zero-point must have the same shape.");if(e.length===3&&e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[0].dataType===6&&e.length>2)throw new Error("In the case of dequantizing int32 there is no zero point.");if(e[1].dims.length!==0&&e[1].dims.length!==1&&e[1].dims.length!==e[0].dims.length)throw new Error("scale input must be a scalar, a 1D tensor, or have the same rank as the input tensor.");if(e.length>2){if(e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[1].dims.length!==e[2].dims.length)throw new Error("scale and zero-point inputs must have the same rank.");if(!e[1].dims.map((i,a)=>i===e[2].dims[a]).reduce((i,a)=>i&&a,!0))throw new Error("scale and zero-point inputs must have the same shape.")}if(t.blockSize>0){if(e[1].dims.length===0||e[1].dims.length===1&&e[1].dims[0]===1)throw new Error("blockSize must be set only for block quantization.");if(!e[1].dims.map((n,r)=>r===t.axis||n===e[0].dims[r]).reduce((n,r)=>n&&r,!0))throw new Error("For block qunatization, scale input shape to match the input shape except for the axis");if(e[1].dims.length!==e[0].dims.length)throw new Error("For block qunatization the scale input rank must be the same as the x rank.");let i=e[0].dims[t.axis],a=e[1].dims[t.axis];if(t.blockSize<Math.ceil(i/a)||t.blockSize>Math.ceil(i/(a-1)-1))throw new Error("blockSize must be with in the range [ceil(dI / Si), ceil(dI / (Si - 1) - 1)].")}},dl=(e,t)=>{let i=O.normalizeAxis(t.axis,e[0].dims.length),a=e[0].dataType,n=a===3,r=e[0].dims,o=e[1].dataType,u=O.size(r),p=a===3||a===2,d=p?[Math.ceil(O.size(e[0].dims)/4)]:e[0].dims,f=e[1].dims,m=e.length>2?e[2]:void 0,g=m?p?[Math.ceil(O.size(m.dims)/4)]:m.dims:void 0,_=f.length===0||f.length===1&&f[0]===1,b=_===!1&&f.length===1,w=ve(u),C=_&&(!p||w===4),v=C?w:1,$=C&&!p?w:1,T=N("input",p?12:a,d.length,$),k=N("scale",o,f.length),S=m?N("zero_point",p?12:a,g.length):void 0,E=K("output",o,r.length,v),z=[T,k];S&&z.push(S);let R=[d,f];m&&R.push(g);let M=[{type:12,data:u/v},{type:12,data:i},{type:12,data:t.blockSize},...Q(...R,r)],L=J=>{let H=[{name:"output_size",type:"u32"},{name:"axis",type:"u32"},{name:"block_size",type:"u32"}];return`
      ...
      }`};return{name:"DequantizeLinear",shaderCache:{hint:t.cacheKey,inputDependencies:S?["rank","rank","rank"]:["rank","rank"]},getShaderSource:L,getRunData:()=>({outputs:[{dims:r,dataType:o}],dispatchGroup:{x:Math.ceil(u/v/64),y:1,z:1},programUniforms:M})}},rf=(e,t)=>{ll(e.inputs,t),e.compute(dl(e.inputs,t))},af=e=>fe({axis:e.axis,blockSize:e.blockSize})}),pl,cl,nf,lg=q(()=>{Le(),re(),oe(),pl=(e,t,i)=>{let a=e===t,n=e<t&&i<0,r=e>t&&i>0;if(a||n||r)throw new Error("Range these inputs' contents are invalid.")},cl=(e,t,i,a)=>{let n=Math.abs(Math.ceil((t-e)/i)),r=[n],o=n,u=[{type:12,data:o},{type:a,data:e},{type:a,data:i},...Q(r)],p=d=>{let f=K("output",a,r.length),m=f.type.value,g=[{name:"outputSize",type:"u32"},{name:"start",type:m},{name:"delta",type:m}];return`
        ${d.registerUniforms(g).declareVariables(f)}
        ${d.mainStart()}
        ${d.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
        output[global_idx] = uniforms.start + ${m}(global_idx) * uniforms.delta;
      }`};return{name:"Range",shaderCache:{hint:`${a}`},getShaderSource:p,getRunData:()=>({outputs:[{dims:r,dataType:a}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:u})}},nf=e=>{let t=0,i=0,a=0;e.inputs[0].dataType===6?(t=e.inputs[0].getInt32Array()[0],i=e.inputs[1].getInt32Array()[0],a=e.inputs[2].getInt32Array()[0]):e.inputs[0].dataType===1&&(t=e.inputs[0].getFloat32Array()[0],i=e.inputs[1].getFloat32Array()[0],a=e.inputs[2].getFloat32Array()[0]),be.webgpu.validateInputContent&&pl(t,i,a),e.compute(cl(t,i,a,e.inputs[0].dataType),{inputs:[]})}}),fl,hl,sf,of,dg=q(()=>{re(),ne(),xe(),oe(),fl=(e,t,i,a)=>{if(e!=="none"&&a!=="i32"&&a!=="u32"&&a!=="f32")throw new Error(`Input ${a} is not supported with reduction ${e}.`);let n=`{
                var oldValue = 0;
                loop {
                  let newValueF32 =`,r=`;
              ...
              ${n}bitcast<${a}>(oldValue) + (${i})${r}`;case"max":return a==="i32"||a==="u32"?`atomicMax(&${t}, bitcast<${a}>(${i}));`:`
                ${n}max(bitcast<f32>(oldValue), (${i}))${r}`;case"min":return a==="i32"||a==="u32"?`atomicMin(&${t}, bitcast<${a}>(${i}));`:`${n}min(bitcast<${a}>(oldValue), (${i}))${r}`;case"mul":return`${n}(bitcast<${a}>(oldValue) * (${i}))${r}`;default:throw new Error(`Reduction ${e} is not supported.`)}},hl=(e,t)=>{let i=e[0].dims,a=e[1].dims,n=i,r=1,o=Math.ceil(O.sizeToDimension(a,a.length-1)/r),u=a[a.length-1],p=O.sizeFromDimension(i,u),d=[{type:12,data:o},{type:12,data:u},{type:12,data:p},...Q(e[1].dims,e[2].dims,n)],f=m=>{let g=N("indices",e[1].dataType,e[1].dims.length),_=N("updates",e[2].dataType,e[2].dims.length,r),b=t.reduction!=="none"&&t.reduction!==""?Bd("output",e[0].dataType,n.length):K("output",e[0].dataType,n.length,r);return`
  ...
  for (var i = 0u; i < uniforms.num_updates_elements; i++) {
    ...
    ${fl(t.reduction,"output[data_offset + i]","value",b.type.value)}
      ...
      }`};return{name:"ScatterND",shaderCache:{hint:`${t.cacheKey}_${t.reduction}`,inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:d}),getShaderSource:f}},sf=e=>fe({reduction:e.reduction}),of=(e,t)=>{e.compute(hl(e.inputs,t),{inputs:[e.inputs[1],e.inputs[2]],outputs:[]})}}),ml,gl,_l,oa,yl,bl,wl,$l,vl,xl,Cl,Tl,ua,kl,Sl,Il,El,zl,uf,lf,pg=q(()=>{re(),ne(),xe(),oe(),ml=(e,t)=>{if(e.every(i=>i>0||(()=>{throw new Error("Resize requires scales input values to be positive")})),e.length>0){if(t.mode==="linear"){if(!(e.length===2||e.length===3||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1||e.length===5&&e[0]===1&&e[1]===1))throw new Error(`For linear mode, Resize requires scales to be 2D, 3D, 4D with either two outermost or one innermost and
 ...
 * limitations under the License.
 * =============================================================================
 */export{gd as K,et as q,be as w};
